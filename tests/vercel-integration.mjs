...
assert.deepEqual((await client.execute('SELECT mode,anchor FROM settings WHERE id=1')).rows.map(r=>({mode:r.mode,anchor:r.anchor})),[{mode:'alternating',anchor:'2026-09-28'}]);
